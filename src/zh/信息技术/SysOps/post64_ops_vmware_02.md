...
通过 [虚拟机系列：虚拟机磁盘文件介绍](https://blog.solex-inc.com/zh/%E4%BF%A1%E6%81%AF%E6%8A%80%E6%9C%AF/SysOps/post65_ops_vmware_01.html) 了解了虚拟机磁盘文件,这篇是学习虚拟机快照的基础原理，对快照管理提高认识。
...
>对一个虚机做快照，相当于将虚机当前的磁盘设为只读模式，然后创建 delta vmdk 文件，它将会接受新的数据写操作。
