import{_ as e,W as l,X as t,Z as s,$ as n,a0 as i,Y as o,G as p}from"./framework-b5535326.js";const c={},r=o(`<h2 id="前言" tabindex="-1"><a class="header-anchor" href="#前言" aria-hidden="true">#</a> 前言</h2><p>处理死锁问题一般都是杀死会话，一般是DBA角色来执行，或是用户授予了使用<code>alter system kill session</code></p><p>但如果想让普通用户在不拥有DBA角色，或不能拥有alter system的情况下杀死会话，可以考虑</p><p>以下方法授权给普通用户。</p><h2 id="正文" tabindex="-1"><a class="header-anchor" href="#正文" aria-hidden="true">#</a> 正文</h2><h3 id="实现方式" tabindex="-1"><a class="header-anchor" href="#实现方式" aria-hidden="true">#</a> 实现方式</h3><ul><li><p>授权这个普通用户可以查询v$session</p></li><li><p>指定1个普通用户创建一个Package,改package的body中包含<code>alter system kill session</code></p></li><li><p>授权这个普通用户可以执行该package</p></li><li><p>授权这个普通用户可以执行<code>alter system</code></p></li><li><p>Oracle Single instance (Source) to Single instance(target)</p></li><li><p>Netbackup Data Backup Environment</p></li></ul><h3 id="实现步骤" tabindex="-1"><a class="header-anchor" href="#实现步骤" aria-hidden="true">#</a> 实现步骤</h3><ul><li>System用户创建Package。</li></ul><div class="language-sql line-numbers-mode" data-ext="sql"><pre class="language-sql"><code>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="参考" tabindex="-1"><a class="header-anchor" href="#参考" aria-hidden="true">#</a> 参考</h2>`,22),d={href:"http://dba-oracle.com/t_granting_alter_system_kill_session.htm",target:"_blank",rel:"noopener noreferrer"};function u(k,v){const a=p("ExternalLinkIcon");return l(),t("div",null,[r,s("p",null,[n("Granting ALTER SYSTEM KILL SESSION to users "),s("a",d,[n("http://dba-oracle.com/t_granting_alter_system_kill_session.htm"),i(a)])])])}const b=e(c,[["render",u],["__file","post78_db_orcl_02.html.vue"]]);export{b as default};
