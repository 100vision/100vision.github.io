...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="参考" tabindex="-1"><a class="header-anchor" href="#参考" aria-hidden="true">#</a> 参考</h2>`,18),v={href:"https://www.v2ex.com/t/956719",target:"_blank",rel:"noopener noreferrer"},u={href:"https://blog.csdn.net/ttzommed/article/details/106759670",target:"_blank",rel:"noopener noreferrer"};function m(b,p){const i=s("ExternalLinkIcon");return l(),d("div",null,[c,e("p",null,[e("a",v,[n("V2EX : docker image 分层的问题"),a(i)])]),e("p",null,[e("a",u,[n("CSDN:SpringBoot2.3.0 + Docker实现分层打包"),a(i)])])])}const h=r(o,[["render",m],["__file","post47_docker_layered_with_springboot.html.vue"]]);export{h as default};
