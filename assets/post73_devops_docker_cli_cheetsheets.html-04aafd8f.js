...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,12),v={class:"hint-container tip"},p=e("p",{class:"hint-container-title"},"编写高效的Dockerfile",-1),b=i(`<h3 id="镜像分析" tabindex="-1"><a class="header-anchor" href="#镜像分析" aria-hidden="true">#</a> 镜像分析</h3><ul><li>查看镜像配置 <code>docker inspect &lt;image ID&gt;</code> ,也可以查看容器配置,把image ID 换成container ID；</li><li>查看镜像的创建历史信息 <code>docker history &lt;image ID 或image name&gt;</code>。可以看到镜像各层的sha256。 使用<code>--no-trunc</code>可以看到完整的sha256</li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>root@runoob:~<span class="token comment"># docker history runoob/ubuntu:v3</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,3),h=e("code",null,"dive",-1),k={href:"https://github.com/wagoodman/dive",target:"_blank",rel:"noopener noreferrer"};function g(_,x){const t=a("RouterLink"),o=a("ExternalLinkIcon");return d(),c("div",null,[m,e("div",v,[p,e("p",null,[n("可以参考另一篇文章"),s(t,{to:"/zh/%E4%BF%A1%E6%81%AF%E6%8A%80%E6%9C%AF/DevOps/post81_devops_docker_tip_01.html"},{default:r(()=>[n(" “如何编写高效的Dockerfile”")]),_:1})])]),b,e("ul",null,[e("li",null,[n("也可以使用其他开源工具分析镜像。例如"),h,n("，项目地址 "),e("a",k,[n("wagoodman / dive "),s(o)])])])])}const q=l(u,[["render",g],["__file","post73_devops_docker_cli_cheetsheets.html.vue"]]);export{q as default};
