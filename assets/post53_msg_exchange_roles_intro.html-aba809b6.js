...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="hint-container tip"><p class="hint-container-title">提示</p><p>(2023/11/10更新）不能添加父角色没有的cmdlet和cmdParameters给角色，否则会收到以下类似异常。例如，当我尝试<code>Set-ManagementRoleEntry &quot;My Mailbox Admins\\new-mailbox&quot; -AddParameter -Parameters Room,RoomMailboxPassword</code>。由于&quot;(Microsoft.Exchange.Management.PowerShell.E2010) New-Mailbox -EnableRoomMailboxAccount -Room -RoomMailboxPassword&quot;管理角色条目的父角色不包含相同角色条目的以下参数，无法将条目添加到&quot;Solex Mailbox Admins&quot;管理角色:&quot;Room,RoomMailboxPassword&quot;。</p></div><p><strong>效果</strong></p><ul><li>改角色的成员登录EAC后，邮件流 - 邮件转发复选框是灰色的，不可以勾选。</li><li>邮箱委托添加成员后不可保存设置。</li></ul><p><strong>小结</strong></p><p>通过以上，可以比较精细控制Exchange管理权限。过程比较花时间的就是找出需要控制的cmdlet和parameters，只能多查询得到。</p><h3 id="授权流程" tabindex="-1"><a class="header-anchor" href="#授权流程" aria-hidden="true">#</a> 授权流程</h3><blockquote><p>通过以下图示一览授权流程。</p></blockquote><figure><img src="`+r+'" alt="授权总览" tabindex="0" loading="lazy"><figcaption>授权总览</figcaption></figure><h2 id="三、总结" tabindex="-1"><a class="header-anchor" href="#三、总结" aria-hidden="true">#</a> 三、总结</h2><ol><li>授权颗粒从大到小分别是：</li></ol><p>默认角色组&gt; 自定义角色组 &gt; 自定义角色</p><ol start="2"><li>授权原则</li></ol><ul><li>一般授权使用默认角色组；</li><li>更细一点选择使用自定义角色组 + 默认角色</li><li>最细一点选择使用自定角色组 + 自定义角色</li></ul><p>根据控制需求选择适合的授权模式。</p>',74),c=[s];function m(u,p){return i(),n("div",null,c)}const b=e(d,[["render",m],["__file","post53_msg_exchange_roles_intro.html.vue"]]);export{b as default};
