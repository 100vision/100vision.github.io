import{_ as s,W as n,X as a,Z as e,$ as t,a0 as l,Y as r,G as d}from"./framework-b5535326.js";const o={},c=r(`<h3 id="脚本功能-列出所有dfs空间下的共享目标文件夹" tabindex="-1"><a class="header-anchor" href="#脚本功能-列出所有dfs空间下的共享目标文件夹" aria-hidden="true">#</a> 脚本功能： 列出所有DFS空间下的共享目标文件夹</h3><div class="hint-container tip"><p class="hint-container-title">前提条件</p><p>需要安装DFSN模块到Powershell</p></div><h3 id="_1、安装dfsn模块" tabindex="-1"><a class="header-anchor" href="#_1、安装dfsn模块" aria-hidden="true">#</a> 1、安装DFSN模块</h3><ul><li>Windows 2012 管理可选特色</li><li>添加功能</li><li>选择RSAT 文件服务工具</li></ul><h3 id="_2、脚本内容" tabindex="-1"><a class="header-anchor" href="#_2、脚本内容" aria-hidden="true">#</a> 2、脚本内容</h3><div class="language-Powershell line-numbers-mode" data-ext="Powershell"><pre class="language-Powershell"><code>function Get-DfsnAllFolderTargets ()
{
