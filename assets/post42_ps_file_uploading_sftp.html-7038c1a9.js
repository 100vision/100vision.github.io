...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="脚本详细说明" tabindex="-1"><a class="header-anchor" href="#脚本详细说明" aria-hidden="true">#</a> 脚本详细说明</h3><ol><li><strong>关于WinSCP Assembly文件准备细节</strong></li></ol><ul><li>WinSCP Assembly文件至关重要，需要在要上传的主机上准备好，这样上传脚本才能工作。</li><li>这些Assembly文件是： <code>WinSCP.exe</code> 和 <code>WinSCPNet.dll</code>,均可以在WinSCP安装目录中找到。如果上传主机没有安装WinSCP,可以通过其他方法准备一份，放到一个指定目录下。</li><li>最后在脚本中使用<code>Add-Type</code>指令指定并加载。</li></ul><div class="hint-container note"><p class="hint-container-title">注</p><p><code>WinSCP.exe</code> 和 <code>WinSCPNet.dll</code> 必须在同一目录下。</p></div><ol start="2"><li><strong>如果上传主机上没有安装WinSCP Assembly文件</strong></li></ol><p>可以搭建一个简单的HTTP服务器，并使用脚本的<code>webclient</code>对象实现下载一个副本。本例中，是使用<code>Node.js</code> 的express部署一个http。</p><ol start="3"><li><strong>关于免密登录sftp服务器的实现细节</strong></li></ol><p>免密登录是因为使用了SSH密钥对.</p><ul><li>密钥对通过WinSCP/putty工具生成。</li><li>然后提前把公钥通过WinSCP下的putty上传到sftp用户主目录下。本例中使用的sftp服务器是sftpGo，是把公钥文本拷贝粘贴到用户profile里保存（通过sftpGO Web admin portal)。</li></ul><div class="hint-container tip"><p class="hint-container-title">提示</p><p>可以先通过WinSCP工具测试是否可以免密登录。</p></div><ol start="4"><li><strong>关于脚本中sftp会话选项参数</strong></li></ol><p>WinSCP的会话参数是通过WinSCP会话工具代码模板生成器生成的，比较方便。使用方法是：</p><ul><li><p>启动WinSCP，新建站点，并生成密钥对用于登录sftp服务器； <img src="`+r+'" alt="1" loading="lazy"><img src="'+c+'" alt="2" loading="lazy"><img src="'+v+'" alt="3" loading="lazy"></p></li><li><p>登录成功后，点击菜单上的【会话】，点击【代码生成】如下图： <img src="'+u+'" alt="1" loading="lazy"><img src="'+p+'" alt="1" loading="lazy"></p></li><li><p>复制代码模板到Powershell ISE或其他IDE。</p></li></ul>',14);function $(A,T){const n=d("ExternalLinkIcon");return o(),a("div",null,[e("div",b,[h,e("p",null,[i("前篇文章 "),e("a",_,[i("在SQL Agent里运行Powershell实现文件上传"),s(n)]),i("介绍了一个文件上传需求，具体实现是通过Powershell调用WinSCP的Assembly实现的，本篇详细介绍。")])]),P,f,e("p",null,[i("官方主页 "),e("a",S,[i("https://winscp.net/eng/download.php"),s(n)])]),g,e("ul",null,[e("li",null,[i("1台可运行sftp服务器（可以使用 "),e("a",C,[i("sftpGo"),s(n)]),i(" 实现部署）和账户，步骤略。")]),y,W]),w,e("p",null,[e("a",q,[i("完整脚本"),s(n)])]),F])}const x=t(m,[["render",$],["__file","post42_ps_file_uploading_sftp.html.vue"]]);export{x as default};
