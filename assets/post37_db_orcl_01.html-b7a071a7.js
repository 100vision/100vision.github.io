import{_ as t,W as r,X as l,Z as e,$ as a,a0 as n,Y as s,G as d}from"./framework-2e6688e7.js";const o={},c={class:"hint-container warning"},u=s('<p class="hint-container-title">Caveat</p><p>Notes to myself only . Use this instrucution at your own risk in production. ::warning</p><h2 id="sincerio" tabindex="-1"><a class="header-anchor" href="#sincerio" aria-hidden="true">#</a> Sincerio</h2><ul><li>Oracle Single instance (Source) to Single instance(target)</li><li>Netbackup Data Backup Environment</li></ul><h3 id="environment" tabindex="-1"><a class="header-anchor" href="#environment" aria-hidden="true">#</a> Environment</h3>',5),v={href:"http://mynbumaster.example.com",target:"_blank",rel:"noopener noreferrer"},b={href:"http://target-db.example.com",target:"_blank",rel:"noopener noreferrer"},m={href:"http://source-db.example.com",target:"_blank",rel:"noopener noreferrer"},h=s(`<h2 id="recovery-procedure" tabindex="-1"><a class="header-anchor" href="#recovery-procedure" aria-hidden="true">#</a> Recovery Procedure</h2><h3 id="check-system-enviroment-variables" tabindex="-1"><a class="header-anchor" href="#check-system-enviroment-variables" aria-hidden="true">#</a> Check System Enviroment Variables</h3><blockquote><p>target database SID must be same as source database. If not modify the one on the target.</p></blockquote><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>[oracle@targetServer ~]$ cat ~/.bash_profile | tr -s &#39;\\n&#39;
# .bash_profile
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>when archive los get ready . re-try the recover operation by executing the recover. if the inconsistency persists, repeat the restore of archvie log until it succeeds</p><p><strong>Finally</strong>, Database</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>SQL&gt; recover database open resetlogs

database is altered
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="side-note" tabindex="-1"><a class="header-anchor" href="#side-note" aria-hidden="true">#</a> Side note</h2><p>why backup size sometimes is larger than actual database size. To verify;</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>SQL&gt; select sum(bytes)/1024/1024/1024  from dba_segments;
...
295.922852             </code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,50);function p(_,f){const i=d("ExternalLinkIcon");return r(),l("div",null,[e("div",c,[u,e("ul",null,[e("li",null,[e("a",v,[a("mynbumaster.example.com"),n(i)]),a(" (Netbackup master)")]),e("li",null,[e("a",b,[a("target-db.example.com"),n(i)]),a(" (Database server to receive the backup for full restore)")]),e("li",null,[e("a",m,[a("source-db.example.com"),n(i)]),a(" (Database server where the backup was taken)")])]),h])])}const x=t(o,[["render",p],["__file","post37_db_orcl_01.html.vue"]]);export{x as default};
