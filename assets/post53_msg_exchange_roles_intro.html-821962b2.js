...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>效果</strong></p><ul><li>改角色的成员登录EAC后，邮件流 - 邮件转发复选框是灰色的，不可以勾选。</li><li>邮箱委托添加成员后不可保存设置。</li></ul><p><strong>小结</strong></p><p>通过以上，可以比较精细控制Exchange管理权限。过程比较花时间的就是找出需要控制的cmdlet和parameters，只能多查询得到。</p><h3 id="授权流程" tabindex="-1"><a class="header-anchor" href="#授权流程" aria-hidden="true">#</a> 授权流程</h3><blockquote><p>通过以下图示一览授权流程。</p></blockquote><figure><img src="`+d+'" alt="授权总览" tabindex="0" loading="lazy"><figcaption>授权总览</figcaption></figure>',67),c=[s];function p(u,m){return i(),n("div",null,c)}const g=e(o,[["render",p],["__file","post53_msg_exchange_roles_intro.html.vue"]]);export{g as default};
