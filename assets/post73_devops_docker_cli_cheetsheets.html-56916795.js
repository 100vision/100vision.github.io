import{_ as c,W as o,X as l,Z as e,$ as i,a0 as r,a1 as a,Y as d,G as s}from"./framework-b5535326.js";const t={},u=d(`<h2 id="前言" tabindex="-1"><a class="header-anchor" href="#前言" aria-hidden="true">#</a> 前言</h2><p>收集一些Docker常用基础命令。</p><h2 id="正文" tabindex="-1"><a class="header-anchor" href="#正文" aria-hidden="true">#</a> 正文</h2><h3 id="镜像管理" tabindex="-1"><a class="header-anchor" href="#镜像管理" aria-hidden="true">#</a> 镜像管理</h3><ul><li><p>查看镜像。<code>docker image ls</code></p></li><li><p>拉镜像。<code>docker pull</code></p></li><li><p>推送（上传）镜像。<code>docker push</code></p></li><li><p>使用镜像源的国内镜像。<code>vi /etc/docker/daemon.json </code></p></li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>    {
