import{_ as t,W as r,X as l,Z as e,$ as a,a0 as i,Y as s,G as d}from"./framework-2e6688e7.js";const o={},c={class:"hint-container warning"},u=e("p",{class:"hint-container-title"},"Caveat",-1),v=e("p",null,"Notes to myself only . Use this instrucution at your own risk in production.",-1),b={class:"hint-container warning"},m=s('<p class="hint-container-title">注意</p><h2 id="scenario" tabindex="-1"><a class="header-anchor" href="#scenario" aria-hidden="true">#</a> Scenario</h2><ul><li>Oracle Single instance (Source) to Single instance(target)</li><li>Netbackup Data Backup Environment</li></ul><h3 id="environment" tabindex="-1"><a class="header-anchor" href="#environment" aria-hidden="true">#</a> Environment</h3>',4),h={href:"http://mynbumaster.example.com",target:"_blank",rel:"noopener noreferrer"},p={href:"http://target-db.example.com",target:"_blank",rel:"noopener noreferrer"},_={href:"http://source-db.example.com",target:"_blank",rel:"noopener noreferrer"},g=s(`<h2 id="recovery-procedure" tabindex="-1"><a class="header-anchor" href="#recovery-procedure" aria-hidden="true">#</a> Recovery Procedure</h2><h3 id="check-system-enviroment-variables" tabindex="-1"><a class="header-anchor" href="#check-system-enviroment-variables" aria-hidden="true">#</a> Check System Enviroment Variables</h3><blockquote><p>target database SID must be same as source database. If not modify the one on the target.</p></blockquote><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>[oracle@targetServer ~]$ cat ~/.bash_profile | tr -s &#39;\\n&#39;
# .bash_profile
...
295.922852             </code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,51);function f(x,E){const n=d("ExternalLinkIcon");return r(),l("div",null,[e("div",c,[u,v,e("div",b,[m,e("ul",null,[e("li",null,[e("a",h,[a("mynbumaster.example.com"),i(n)]),a(" (Netbackup master)")]),e("li",null,[e("a",p,[a("target-db.example.com"),i(n)]),a(" (Database server to receive the backup for full restore)")]),e("li",null,[e("a",_,[a("source-db.example.com"),i(n)]),a(" (Database server where the backup was taken)")])]),g])])])}const N=t(o,[["render",f],["__file","post37_db_orcl_01.html.vue"]]);export{N as default};
